...
- When drafting cover letters, pull from `/etc/nixos/openclaw/reference/full-profile.md` for specific metrics and stories
...
- For polished, ready-to-adapt responses by question type, read `/etc/nixos/openclaw/reference/reusable-responses.md`
...
### Narrative
AI engineer and CTO/founder with a 2-month runway, automating his entire job search and content pipeline with OpenClaw on NixOS, building in the open. This story is inherently compelling because it's real, high-stakes, and technical.

### Content Pillars
1. **Build in public:** What I shipped, what broke, what I learned. Daily updates.
2. **AI/agent engineering:** Technical insights from building agents, OpenClaw setup, automation
...
Maintained at `~/openclaw-data/job-tracker.json`
...
Same location: `~/openclaw-data/freelance-tracker.json`
...
Reference `/etc/nixos/openclaw/reference/full-profile.md` for full versions. Quick index:
